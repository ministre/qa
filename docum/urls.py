...
urlpatterns = [
    ...
    path('<int:device_id>/create/', views.DocumCreate.as_view(), name='docum_create'),
    path('<int:device_id>/update/<int:pk>/', views.DocumUpdate.as_view(), name='docum_update'),
    path('<int:device_id>/delete/<int:pk>/', views.DocumDelete.as_view(), name='docum_delete'),
]
