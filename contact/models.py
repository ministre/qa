...
class Contact(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='contact_c', on_delete=models.CASCADE)
    created_at = models.DateTimeField(default=timezone.now)
    updated_by = models.ForeignKey(User, related_name='contact_u', on_delete=models.CASCADE)
