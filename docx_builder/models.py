...
class DocxProfile(models.Model):
    ...
    heading1_font_italic = models.BooleanField(blank=True, null=True, default=False)
    ...
    heading2_font_name = models.CharField(max_length=1000, blank=True, null=True, default='Cambria')
    heading2_font_color_red = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(255)])
    heading2_font_color_green = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(255)])
    heading2_font_color_blue = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(255)])
    heading2_font_size = models.IntegerField(default=14, validators=[MinValueValidator(10), MaxValueValidator(40)])
    heading2_font_bold = models.BooleanField(blank=True, null=True, default=True)
    heading2_font_italic = models.BooleanField(blank=True, null=True, default=False)
    heading2_font_underline = models.BooleanField(blank=True, null=True, default=False)
    heading2_space_before = models.IntegerField(default=5, validators=[MinValueValidator(0), MaxValueValidator(40)])
    heading2_space_after = models.IntegerField(default=5, validators=[MinValueValidator(0), MaxValueValidator(40)])
